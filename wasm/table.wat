...
(module
    ...
    (func $innertimes2 (type $int2int)
        (i32.add (local.get 0) (local.get 0))
    )

    ;; Simple function that adds its parameter to itself twice and returns the sum.
    (func $innertimes3 (type $int2int)
        (i32.add (local.get 0) (local.get 0))
        local.get 0
        i32.add
    )
    ...
    (table 32 funcref)
    (elem (i32.const 16) $innertimes2 $innertimes3)
